...
class APass1 {
    public static void main(String args[]) throws NullPointerException, FileNotFoundException {
        ...
        String line;
        try {
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Anusha Shetty\\Desktop\\Apeksha\\SE Books\\hci\\Sample.txt"));
            BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\Anusha Shetty\\Desktop\\Apeksha\\SE Books\\hci\\Output.txt"));
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Anusha Shetty\\Desktop\\Apeksha\\SE Books\\hci\\Output.txt"));
            System.out.println("\n** Output.txt **\n");
